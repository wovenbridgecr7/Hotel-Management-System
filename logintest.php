...
<link href="bootstrap-4.3.1-dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="text-center">
    ...
    <div data-brackets-id='7721' class="container d-flex justify-content-between">
        ...
        <strong data-brackets-id='7723' id="linkmod">WOVEN PICKED</strong>
          ...
          <a data-brackets-id='7724' href="page-2.html" class="navbar-brand d-flex align-items-center">
    ...
    <form class="form-signin" id="form" action="cnm.php" method="post">
  ...
  <button class="btn btn-lg btn-primary btn-block" type="submit" id="butto" name="login">Sign in</button>
