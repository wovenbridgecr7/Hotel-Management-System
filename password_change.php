<html>
    ...
    <link href="bootstrap-4.3.1-dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        <link href="stylining1.css" rel="stylesheet">
	<meta charset="utf-8">
   ...
   <td>Enter your UserName</td>
    <td><input type="username" size="10" name="username" class="form-control"></td>
    </tr>
    <tr>
  ...
  <tr>
   ...
   <td><input type="password" size="10" name="confirmnewpassword" class="form-control"></td>
    ...
    <p><input type="submit" value="Update Password" class="btn btn-primary">
    </form>
<hr>
	<div id="this">
	<h2> Delete Record</h2>
   ...
   <td>Enter your UserName</td>
    ...
    <td><input type="submit" value="delete record" class="btn btn-primary"></td>
    </tr>
	</table>
